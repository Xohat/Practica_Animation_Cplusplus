...
* @brief Hija de Geometry, crea un rectángulo pero carece de colisiones físicas, solo actúa comno un sensor
...
/// <summary>
/// Hija de Geometry, crea un rectángulo pero carece de colisiones físicas, solo actúa comno un sensor
/// </summary>
