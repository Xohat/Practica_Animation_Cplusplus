...
* @brief Hija de Geometry, se encarga de crear rectangulos con angulación en la escena
...
/// <summary>
/// Hija de Geometry, se encarga de crear rectangulos con angulación en la escena
/// </summary>
