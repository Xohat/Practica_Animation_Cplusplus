/**
* @file Fire.h
* @brief Hija de Geometry, se encarga de crear la entidad del fuego, que resettea la escena al hacer contacto con la bola "Player"
...
/// <summary>
/// Hija de Geometry, se encarga de crear la entidad del fuego, que resettea la escena al hacer contacto con la bola "Player"
/// </summary>
class Fire : public Geometry 
{
	float width;
	float height;
	Color color;
...
public:
	...
	//STATIC
	Fire(float given_width, float given_height, Scene* given_scene) : Geometry(*given_scene)
	{
		width = given_width;
		height = given_height;
	}
	...
	{
		shared_ptr< Fire > rectangle(new Fire(width, height, scene));
